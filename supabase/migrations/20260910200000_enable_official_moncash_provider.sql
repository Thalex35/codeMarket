ALTER TABLE public.purchases
  ...
  ADD CONSTRAINT purchases_payment_method_valid CHECK (
    payment_method IN ('whatsapp', 'moncashconnect', 'official-moncash')
  );
...
BEGIN
  ...
  IF NEW.status <> 'pending' OR NOT (NEW.payment_method IN ('whatsapp', 'moncashconnect', 'official-moncash')) THEN
